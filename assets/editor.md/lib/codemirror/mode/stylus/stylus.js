...
(function (mod) {
    ...
    var wordOperators = ["in", "and", "or", "not", "is a", "is", "isnt", "defined", "if unless"], commonKeywords = ["for", "if", "else", "unless", "return"], commonAtoms = ["null", "true", "false", "href", "title", "type", "not-allowed", "readonly", "disabled"], commonDef = ["@font-face", "@keyframes", "@media", "@viewport", "@page", "@host", "@supports", "@block", "@css"], cssTypeSelectors = keySet(cssTypeSelectors_), cssProperties = keySet(cssProperties_), cssValues = keySet(cssValues_.concat(cssColorValues_)), hintWords = wordOperators.concat(commonKeywords, commonAtoms, commonDef, cssTypeSelectors_, cssProperties_, cssValues_, cssValuesWithBrackets_, cssColorValues_);
