        ...
        * match the input selection.
        ...
        function makeCmSelection(cm, sel, mode, exclusive) {
            ...
            if (mode == 'char') {
                ...
                var top = Math.min(anchor.line, head.line), left = Math.min(anchor.ch, head.ch), bottom = Math.max(anchor.line, head.line), right = Math.max(anchor.ch, head.ch) + 1;
        ...
        function getMarkPos(cm, vim, markName) {
            if (markName == '\'') {
                ...
                if (cm.doc.history.lastModTime == 0) {
                    ...
                    var changeHistory = cm.doc.history.done.filter(function (el) { if (el.changes !== undefined) {
                        return el;
                    } });
