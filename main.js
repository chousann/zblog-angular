...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.login = function (token) {
        ...
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + 'authInfo?AuthToken=' + token, {})
            .then(function (responseDto) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var authData;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                authData = responseDto.data;
                if (authData) {
...
var UploadComponent = /** @class */ (function () {
    ...
    UploadComponent.prototype.fileUpload = function () {
        ...
        this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].baseUrl + "post/upload?AuthToken=" + this.rootWebDto.accountProfile.authToken, formData)
            ...
            _this.path = _this.baseUrl + "store/storage/md/" + _this.rootWebDto.accountProfile.username + "/" + data[0].path;
        ...
        this.vditor = new vditor__WEBPACK_IMPORTED_MODULE_4___default.a('vditor', {
            ...
            upload: {
                ...
                format: function (File, msg) {
                    ...
                    var dealData = res.data.uploadList;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ResponseData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ResponseData */ "./src/app/model/ResponseData.ts");



var AccountProfile = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AccountProfile, _super);
...
}(_ResponseData__WEBPACK_IMPORTED_MODULE_2__["ResponseData"]));
...
var AdminOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AdminOut, _super);
    function AdminOut() {
...
/* harmony import */ var _ResponseData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ResponseData */ "./src/app/model/ResponseData.ts");




var ChannelDetailOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ChannelDetailOut, _super);
...
}(_ResponseData__WEBPACK_IMPORTED_MODULE_3__["ResponseData"]));
...
var ChannelOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ChannelOut, _super);
    function ChannelOut() {
        return _super.call(this) || this;
    }
...
var EditingOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](EditingOut, _super);
    function EditingOut() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var LastestOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](LastestOut, _super);
    function LastestOut() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var PostListOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](PostListOut, _super);
    function PostListOut() {
        var _this = _super.call(this) || this;
        _this.page = new _Page__WEBPACK_IMPORTED_MODULE_2__["Page"]();
        return _this;
    }
...
var SearchResqponseOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SearchResqponseOut, _super);
...
var SiteInfo = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SiteInfo, _super);
    function SiteInfo() {
...
var TagDetailOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TagDetailOut, _super);
    function TagDetailOut() {
        var _this = _super.call(this) || this;
        _this.results = new _Page__WEBPACK_IMPORTED_MODULE_2__["Page"]();
        return _this;
    }
...
var UserInfoOut = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](UserInfoOut, _super);
    function UserInfoOut() {
        var _this = _super.call(this) || this;
        _this.user = new _UserVO__WEBPACK_IMPORTED_MODULE_2__["UserVO"]();
        return _this;
    }
...
var EditingComponent = /** @class */ (function () {
    ...
    EditingComponent.prototype.getEditingInit = function () {
        ...
        this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + 'post/editing?AuthToken=' + this.rootWebDto.accountProfile.authToken, {})
            .then(function (res) {
            _this.editingOut = res.data;
            _this.initPost(res.data);
            console.log("success");
        })
            .catch(function () {
            console.log("error");
...
module.exports = "<div class=\"row streams\">\r\n  <div class=\"col-xs-12 col-md-9 side-left\">\r\n    <div class=\"posts \">\r\n      <ul class=\"posts-list\">\r\n        <li class=\"content\">\r\n          <div class=\"content-box posts-aside\">\r\n            <div class=\"posts-item\">标签: {{tagDetail.name}} 共 {{tagDetail.results.content.length}} 个结果.</div>\r\n          </div>\r\n        </li>\r\n        <app-list [allposts]=\"tagDetail.results\"></app-list>\r\n      </ul>\r\n    </div>\r\n    <div class=\"text-center\">\r\n      <!-- <@utils.pager request.requestURI, results, 5/> -->\r\n    </div>\r\n  </div>\r\n  <div class=\"col-xs-12 col-md-3 side-right\">\r\n    <app-right></app-right>\r\n  </div>\r\n</div>"
